...
class BaseSchemaValidator:
    ...
    def _validate_single_file_xsd(self, xml_file, base_path):
        ...
        try:
            ...
            # encoding="utf-8" required: without it, open() uses the platform
            # default (cp1251 on Windows) which can't decode bytes like 0x98 in
            # fontTable.xml. OOXML files are always UTF-8.
