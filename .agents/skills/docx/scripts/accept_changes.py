...
def _setup_libreoffice_macro() -> bool:
    ...
    # encoding="utf-8": macro file is XML (UTF-8). Without it, read_text()
    # uses platform default (cp1251 on Windows) which can't decode non-ASCII.
    ...
    try:
        # encoding="utf-8": macro content declares <?xml encoding="UTF-8"?>,
        # so the file MUST be written as UTF-8 (not platform-default cp1251).
